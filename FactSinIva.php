	...
	<form name="datosOperacionForm" action="" method="post" style="font-size: 20px;">
		<div class="jig_borde" align="center">
			<div class="jig_contenido" id="detalles_datos" style="font-size: 20px;">
				...
				<input type="text" name="cantidad" maxlength="10" id="" onkeyup="calcularSubtotalDetalle(1);" onchange="calcularSubtotalDetalle(1);" value="1"></td>
				...
				<input type="text" name="detallePrecio" maxlength="19" id="detalle_precio1" onchange="calcularSubtotalDetalle(1);"></td>
		...
		<input type="button" value="< Volver" onclick="parent.history.back();">&nbsp;<input type="submit" value="Guardar >" onclick="document.print();">
		</div>
