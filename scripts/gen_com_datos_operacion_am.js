...
function insertarFilaDetalle()
{
	...
	c[0].innerHTML = "<input type='text' name='detalleCodigoArticulo' maxlength='19' size='12' /><input type='hidden' name='detalleNroLinea' />";
	...
	c[2].innerHTML = "<input type='text' name='detalleCantidad' maxlength='9' id='detalle_cantidad"+numFilasDetallesMax+"' onkeyup='calcularSubtotalDetalle("+numFilasDetallesMax+");' onchange='calcularSubtotalDetalle("+numFilasDetallesMax+");' value='1' size='10' />";
